# Global primary plastic production by industrial sector - Data package

This data package contains the data that powers the chart ["Global primary plastic production by industrial sector"](https://ourworldindata.org/grapher/plastic-production-by-sector?time=2000..latest&v=1&csvType=filtered&useColumnShortNames=false) on the Our World in Data website.
